...
using namespace std;
string nombres ( string player_1, string player_2){ //Declaramos una funci�n que registre el nombre de los 2 jugadores.
    string jugadores;
    jugadores = player_1 + "" + player_2;
    return jugadores;
}
void fichas (int filas){ //Declaramo una funci�n que dibuje las fichas.
...
void graficos (int fila_a, int fila_b, int fila_c) {//declarmos una funcion que llamara a la funci�n anterior para dibujar las filas de el juego.
    cout<<"Fila 1:          "; fichas (fila_a);
    cout<<"Fila 2:         "; fichas (fila_b);
    cout<<"Fila 3:        "; fichas (fila_c);
    }
void limpiar (int pantalla){//Funci�n que nos ayuda a limpiar la pantalla cada vez que sea necesario.
 #ifdef _WIN32
        system("cls"); // Windows
    #else
...
int main (){
    ...
    do {
        limpiar (limpio);
        int fila_1=3, fila_2=5, fila_3 = 7; //Variables para los gr�ficos
        ...
        while (fila_1 + fila_2 + fila_3 > 1){
            ...
            if (quitar_fila == 1) {
                ...
                while (quitar_ficha < 1 || quitar_ficha > fila_1) {
                    cout << "Por favor, ingrese un n�mero v�lido de fichas a quitar (1 al " << fila_1 << "): ";
                    cin >> quitar_ficha;
                }
                ...
                while (quitar_ficha < 1 || quitar_ficha > fila_2) {
                    cout << "Por favor, ingrese un n�mero v�lido de fichas a quitar (1 al " << fila_2 << "): ";
                    cin >> quitar_ficha;
                }
                ...
                while (quitar_ficha < 1 || quitar_ficha > fila_3) {
                    cout << "Por favor, ingrese un n�mero v�lido de fichas a quitar (1 al " << fila_3 << "): ";
                    cin >> quitar_ficha;
                }
